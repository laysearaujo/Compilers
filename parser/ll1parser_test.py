...
def testGrammar10_parsingTable():
    L = Nonterminal('L')
    R = Nonterminal('R')
    Q = Nonterminal('Q')
    a = Terminal('a')
...
def testGrammar11_parsingTable():
    A = Nonterminal('A')
    B = Nonterminal('B')
    C = Nonterminal('C')
    a = Terminal('a')
...
def testGrammar12_parsingTable():
    A = Nonterminal('A')
    B = Nonterminal('B')
    C = Nonterminal('C')
    a = Terminal('a')
